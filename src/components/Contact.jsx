...
<article className='shadow-lg rounded-lg flex flex-col md:flex-row max-w-4xl w-full relative'>
    <aside className='w-full md:w-1/2 relative'>
        ...
        w-[300px] h-[300px] sm:w-[400px] sm:h-[400px] rounded-full bg-gradient-to-r from-[#6d2897]
         via-[#8e6cf5] to-[#bb61c5] shadow -[0_0_70px_rgba(182,0,182,0.7]'></div>
        <img src={girlphoto} alt="contact picture" 
        className='h-[300px] sm:h-[400px] sm:w-[400px] md:h-[480px] w-[300px] object-center rounded-t-lg
        md:rounded-r-lg relative '/>
    </aside>
    {/*Contact Form */}
   <section className='p-8 w-full md:w-1/2'>
   <header className='mb-6'>
    <h2 className='text-4xl text-center font-bold text-white'>Contact Me</h2>
   </header>
...
<textarea type="message" id="message" name='message' placeholder="Your message"
className='w-full px-4 py-2 text-white bg-gray-900 rounded-lg focus:outline-none'></textarea>
    </div>
<button className='w-full text-white border-2 py-2 px-6 focus:outline-none
